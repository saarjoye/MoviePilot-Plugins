...
const _hoisted_7 = { class: "panel-head" };
const _hoisted_8 = { class: "panel-subtitle" };
const _hoisted_9 = { class: "search-bar" };
const _hoisted_10 = {
  key: 0,
  class: "result-grid"
};
const _hoisted_11 = { class: "result-title" };
...
const _hoisted_15 = { class: "panel-head" };
const _hoisted_16 = { class: "panel-subtitle" };
const _hoisted_17 = { class: "media-overview" };
const _hoisted_18 = { class: "media-copy" };
const _hoisted_19 = { class: "fact-list" };
const _hoisted_20 = { class: "meta-grid" };
const _hoisted_21 = { class: "media-content" };
const _hoisted_22 = {
  key: 0,
  class: "group-grid"
};
const _hoisted_23 = { class: "group-title" };
const _hoisted_24 = { class: "group-subtitle" };
const _hoisted_25 = { class: "panel-head" };
const _hoisted_26 = { class: "panel-subtitle" };
const _hoisted_27 = {
  key: 0,
  class: "queue-list"
};
const _hoisted_28 = { class: "queue-title" };
const _hoisted_29 = { class: "queue-path" };
const _hoisted_30 = { class: "queue-path" };
const _hoisted_31 = { class: "queue-path" };
const _hoisted_32 = { class: "queue-path" };
const _hoisted_33 = { class: "queue-status" };
const _hoisted_34 = { class: "dialog-title" };
const _hoisted_35 = { class: "dialog-subtitle" };
const _hoisted_36 = { class: "dialog-entry-url" };
const _hoisted_37 = { class: "dialog-entry-pass" };
const _hoisted_38 = {
  key: 0,
  class: "dialog-summary"
};
const _hoisted_39 = { class: "dialog-title" };
const _hoisted_40 = { class: "dialog-entry-url" };
const _hoisted_41 = { class: "dialog-entry-pass" };
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _createElementVNode("div", _hoisted_3, [
        _cache[6] || (_cache[6] = _createElementVNode("div", { class: "eyebrow" }, "Panlink115", -1)),
        _cache[7] || (_cache[7] = _createElementVNode("h1", null, "直连 115 分享转存", -1)),
    ...
    _createVNode(_component_VAlert, {
      ...
      default: _withCtx(() => [
        _createTextVNode(" MP u115：" + _toDisplayString(pluginState.value.mp_u115_ready ? "已就绪" : "未就绪") + "， 115 Cookie：" + _toDisplayString(pluginState.value.u115_cookie_configured ? "已配置" : "未配置"), 1)
      ]),
      _: 1
    }, 8, ["type"]),
    _createElementVNode("div", _hoisted_6, [
      _createElementVNode("div", _hoisted_7, [
        _createElementVNode("div", null, [
          _cache[9] || (_cache[9] = _createElementVNode("div", { class: "panel-title" }, "搜索资源", -1)),
          _createElementVNode("div", _hoisted_8, _toDisplayString(resultCountText.value), 1)
        ])
      ]),
                  ...
                  _createVNode(_component_VCardText, { class: "d-flex flex-column ga-3" }, {
                    default: _withCtx(() => [
                      _createElementVNode("div", null, [
                        ...
                        _createElementVNode("div", _hoisted_12, _toDisplayString(resultSubtitle(item) || "暂无附加信息"), 1)
                      ]),
    ...
    (selectedMedia.value)
      ? (_openBlock(), _createElementBlock("div", _hoisted_14, [
          _createElementVNode("div", _hoisted_15, [
            _createElementVNode("div", null, [
              _cache[12] || (_cache[12] = _createElementVNode("div", { class: "panel-title" }, "资源详情", -1)),
              _createElementVNode("div", _hoisted_16, _toDisplayString(selectedMedia.value.vod_name), 1)
            ])
          ]),
          _createElementVNode("div", _hoisted_17, [
            ...
            _createElementVNode("div", _hoisted_18, [
              ...
              _createElementVNode("p", _hoisted_21, _toDisplayString(selectedMedia.value.vod_content || "暂无剧情简介"), 1)
            ])
          ]),
                  ...
                  return (_openBlock(), _createBlock(_component_VCard, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VCardText, null, {
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_23, _toDisplayString(group.label), 1),
                          _createElementVNode("div", _hoisted_24, _toDisplayString(group.count) + " 条链接", 1)
                        ]),
                        _: 2
                      }, 1024)
                    ]),
    ...
    _createElementVNode("div", {
      ...
      _createElementVNode("div", _hoisted_25, [
        _createElementVNode("div", null, [
          _cache[13] || (_cache[13] = _createElementVNode("div", { class: "panel-title" }, "任务队列", -1)),
          _createElementVNode("div", _hoisted_26, _toDisplayString(queueCountText.value), 1)
        ]),
        _createVNode(_component_VBtn, {
          variant: "text",
              ...
              return (_openBlock(), _createBlock(_component_VCard, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_VCardText, { class: "d-flex flex-column ga-2" }, {
                    default: _withCtx(() => [
                      _createElementVNode("div", _hoisted_28, _toDisplayString(item.vod_name || item.title), 1),
                      _createElementVNode("div", _hoisted_29, "分类：" + _toDisplayString(item.category_group) + " / " + _toDisplayString(item.category_name), 1),
                      _createElementVNode("div", _hoisted_30, "目标目录：" + _toDisplayString(item.target_path), 1),
                      _createElementVNode("div", _hoisted_31, "目标 CID：" + _toDisplayString(item.target_cid || "未知"), 1),
                      _createElementVNode("div", _hoisted_32, "认证：" + _toDisplayString(item.auth_label || "115 网页 Cookie"), 1),
                      _createElementVNode("div", _hoisted_33, _toDisplayString(item.status), 1)
                    ]),
                    _: 2
                  }, 1024)
                ]),
                  ...
                  return (_openBlock(), _createBlock(_component_VCard, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_VCardText, { class: "d-flex flex-column ga-3" }, {
                        default: _withCtx(() => [
                          _createElementVNode("div", null, [
                            _createElementVNode("div", _hoisted_34, _toDisplayString(entry.title || "未命名资源"), 1),
                            _createElementVNode("div", _hoisted_35, _toDisplayString(entrySubtitle(entry)), 1)
                          ]),
                          _createElementVNode("div", _hoisted_36, _toDisplayString(entry.url), 1),
                          _createElementVNode("div", _hoisted_37, "提取码：" + _toDisplayString(entry.password || "无"), 1),
                          _createVNode(_component_VBtn, {
                            color: "primary",
              ...
              default: _withCtx(() => [
                ...
                (selectedEntry.value)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_38, [
                      _createElementVNode("div", _hoisted_39, _toDisplayString(selectedEntry.value.title || "未命名资源"), 1),
                      _createElementVNode("div", _hoisted_40, _toDisplayString(selectedEntry.value.url), 1),
                      _createElementVNode("div", _hoisted_41, "提取码：" + _toDisplayString(selectedEntry.value.password || "无"), 1)
                    ]))
                  : _createCommentVNode("", true),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-08f7cad6"]]);
